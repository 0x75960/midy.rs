...
mod tests {
    ...
    #[test]
    fn test_is_sha256() {
        assert_eq!(true, is_sha256(&"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"));
        assert_eq!(false, is_sha256(&"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b85"));
        assert_eq!(true, is_sha256(&"E3B0C44298FC1C149AFBF4C8996FB92427AE41E4649B934CA495991B7852B855"));
        assert_eq!(false, is_sha256(&"E3B0C44298FC1C149AFBF4C8996FB92427AE41E4649B934CA495991B7852B85"));
    }
    ...
    fn test_detect() {
        ...
        assert_eq!(HashType::SHA1, detect(&"da39a3ee5e6b4b0d3255bfef95601890afd80709"));
        assert_eq!(HashType::SHA256, detect(&"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"));
    ...
    fn test_is_empty() {
        ...
        assert_eq!(true, is_empty(&"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"));
        ...
        assert_eq!(false, is_empty(&"e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b856"));
    }
    ...
    fn test_find_sha1() {
        ...
        assert_eq!(1, found.len());
        assert_eq!(true, found.contains("da39a3ee5e6b4b0d3255bfef95601890afd80709"));
    }
    ...
    fn test_find_sha256() {
        ...
        assert_eq!(1, found.len());
        assert_eq!(true, found.contains("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"));
    }
